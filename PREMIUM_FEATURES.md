...
```mermaid
gantt
    title Premium Features Rollout
    dateFormat YYYY-MM
    section Phase 1 — Quick Wins
    Unlimited Tabs & Workspaces    :p1a, 2026-09, 2w
    Theme Skins (Dark Mode + XP)   :p1b, after p1a, 2w
    JSON & DDL Export              :p1c, after p1a, 1w
    Shareable Query Links          :p1d, after p1c, 2w
    section Phase 2 — Core Value
    Cloud Sync & Persistence       :p2a, 2026-10, 3w
    Advanced Data Generation       :p2b, after p2a, 2w
    Chart Builder & Dashboards     :p2c, after p2b, 3w
    section Phase 3 — AI & Live
    AI SQL Copilot                 :p3a, 2026-11, 4w
    Live Database Connections      :p3b, after p3a, 4w
    section Phase 4 — Scale
    Collaboration & Teams          :p4a, 2027-01, 4w
    Teaching & Challenge Mode      :p4b, after p4a, 4w
```
